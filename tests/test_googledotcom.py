...
class TestFormulaConverter(unittest.TestCase):
    ...
    @unittest.skip('TRIAL ONLY')
    def test_matching_formula_parts(self):
        ...
        formula = FormulaConverter._FORMULA.format(braces=FormulaConverter._BRACES,
    ...
    def test_matching_dynamic_coordinates(self):
        ...
        formula = FormulaConverter._FORMULA.format(ws=FormulaConverter._WS,
                                                   ...
                                                   casual_math_ops=FormulaConverter._CASUAL_MATH_OPS,
                                                   variables='[ABCDEFGHIJKLMNOPQRST]')
        dynamic_coordinates = FormulaConverter._DYNAMIC_COORDINATES.format(
            ws=FormulaConverter._WS,
    ...
    def test_match_simple_dynamic_coordinates(self):
