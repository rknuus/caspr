...
def _parse_args(args):
    ...
    parser.add_argument('-u', '--user', action='store', required=True, help="your geocaching account")
    parser.add_argument('-p', '--password', action='store', required=True, help="your geocaching password")
